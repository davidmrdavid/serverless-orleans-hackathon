...
namespace OrleansConnector.Algorithm
{
    ...
    abstract class BatchWorker<T>
    {
        ...
        /// </summary>
        public BatchWorker(bool startSuspended, int maxBatchSize, CancellationToken cancellationToken)
        {
        ...
        async Task Work()
        {
            ...
            while (!this.cancellationToken.IsCancellationRequested)
            {
                ...
                {
                    this.Tracer?.Invoke($"executed batch size={previousBatch.Value} elapsed={this.stopwatch.Elapsed.TotalMilliseconds} next={nextBatch}");
                }
